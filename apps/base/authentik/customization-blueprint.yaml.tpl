version: 1
metadata:
  # Keep this name stable: it is unique-constrained in authentik's database and
  # the ConfigMap it ships in now has a stable name too, so the same
  # BlueprintInstance is updated in place on every change.
